...
const REMAP: &str = "./gamepad/remap/remap.sdb";
const REMAP_SDL: &str = "./gamepad/remap/remap_sdl.sdb";
const LINUX: &str = "./gamepad/remap/sdb/linux/";
const _MACOS: &str = "./gamepad/remap/sdb/macos/";
const _WINDOWS: &str = "./gamepad/remap/sdb/windows/";
const _WEB: &str = "./gamepad/remap/sdb/web/";
const _USB: &str = "./gamepad/remap/sdb/usb/";

const SDL: &str = "./gamepad/remap/gcdb/gamecontrollerdb.txt";
...
pub(super) fn main() {
    ...
    std::fs::write(REMAP_SDL, out).unwrap();
}
