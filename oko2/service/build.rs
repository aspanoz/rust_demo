...
fn generate_toml_variables() -> Result<()> {
    ...
    writeln!(
        &mut file,
        r#"/// Этот файл автоматически создан скриптом build.rs"#
    )?;

    writeln!(&mut file, "")?;
    writeln!(
        &mut file,
        r#"/// Версия приложения, данные из {TOML_SOURCES}"#
    )?;
    writeln!(
        &mut file,
    ...
    writeln!(
        &mut file,
        r#"/// Описание приложения, данные из {TOML_SOURCES}"#
    )?;
    writeln!(
        &mut file,
    ...
    writeln!(
        &mut file,
        r#"/// Название приеложения, данные из {TOML_SOURCES}"#
    )?;
    writeln!(
        &mut file,
